...
public class TodoCommandLineRunner implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    todoRepository.save(new Todo("JohnDoe", "Complete Todolist", LocalDate.now().plusDays(2), false));
    todoRepository.save(new Todo("JohnDoe", "Complete Portal App", LocalDate.now().plusDays(2), false));
